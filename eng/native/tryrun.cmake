...
if(NOT DEFINED ANDROID_BUILD)
  ...
  elseif(EXISTS ${CROSS_ROOTFS}/FreeRTOS OR EXISTS ${CROSS_ROOTFS}/freertos)
    set(FREERTOS 1)
    set(CLR_CMAKE_TARGET_OS freertos)
  endif()
endif()
...
elseif(DEFINED ANDROID_BUILD OR TARGET_ARCH_NAME MATCHES "^(armel|arm|armv6|arm64|loongarch64|riscv64|s390x|ppc64le|x86|x64)$" OR FREEBSD OR ILLUMOS OR TIZEN OR HAIKU OR FREERTOS)
  ...
  elseif(HAIKU)
    ...
    set_cache_value(HAVE_PROCFS_STATM_EXITCODE 1)
  elseif(FREERTOS)
    # FreeRTOS is an RTOS without typical POSIX features
    set_cache_value(HAS_POSIX_SEMAPHORES_EXITCODE 1)
    set_cache_value(HAVE_CLOCK_MONOTONIC_COARSE_EXITCODE 1)
    set_cache_value(HAVE_MMAP_DEV_ZERO_EXITCODE 1)
    set_cache_value(HAVE_PROCFS_CTL_EXITCODE 1)
